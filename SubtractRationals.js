/**
 *  * This script generates a CSV of problems for subtracting and simplifying
                                                                                                                                       ...
                                                                                                                                       m = randomItem([1, 2, 3, 4, 5, 6, 7, 8, 9]);
                                                                                                                                           do {
                                                                                                                                                 n = randomItem([1, 2, 3, 4, 5, 6, 7, 8, 9]);
                                                                                                                                                         ...
                                                                                                                                                         // 2. Calculate the simplified numerator's coefficients for SUBTRACTION.
                                                                                                                                                             // (a*x+b)(x+n) - (c*x+d)(x+m)
                                                                                                                                                                 // (ax^2 + anx + bx + bn) - (cx^2 + cmx + dx + dm)
                                                                                                                                                                     // (a-c)x^2 + (an+b-cm-d)x + (bn-dm)
                                                                                                                                                                         A = a - c;
                                                                                                                                                                             B = a * n + b - c * m - d;
                                                                                                                                                                                 C = b * n - d * m;
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             const rootNumerator1 = -B + sqrtDiscriminant;
                                                                                                                                                                                                                   const rootNumerator2 = -B - sqrtDiscriminant;
                                                                                                                                                                                                                         const rootDenominator = 2 * A;
                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                               if (rootDenominator !== 0 && rootNumerator1 % rootDenominator === 0 && rootNumerator2 % rootDenominator === 0) {
